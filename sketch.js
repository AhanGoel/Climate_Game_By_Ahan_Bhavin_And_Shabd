...
gameover, gameoveri, 
restart1, restarti, 
sound1, sound2, sound3, s1, s2, s3, treeImg, cut1, cut2, cut3, cut4, bgimg, bgImg2;
...
background(desertImg)
 ...
 //trex.changeAnimation('collided', trex_c);
  ...
  if(gamestate == 'play'){
    textSize(20);
    fill('white');
    text('Press space to jump and avoid the trees',displayWidth/2-150,30);
  }
  ...
  if (gamestate == 'end'){
    ...
    textSize(20);
    fill('white');
    text('The tree has been cut', displayWidth/2 - 80, displayHeight/2-100);
